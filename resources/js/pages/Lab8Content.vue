...
<template>
        <a :href="ArticleController.createFormArticle.url()" v-if="$page.props.auth.user" class="mb-4">
            <Button>Создать статью </Button>
        </a>

        <template v-for="(article, index) in articles">
                <div class="one-post relative px-8 rounded-2xl mb-2">
                    <div class="post-managment">
                        ...
                        <p class="fold-button" :data-hide="index">Свернуть</p>
                    </div>
                    <div :class="'need-to-hide-' + index">
